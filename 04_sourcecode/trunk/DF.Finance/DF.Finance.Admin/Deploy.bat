...
set "backupPath=%home%\Backup\DF_Finance_Admin"
:: the folder which stores the compiled files
set "srcPath=%home%\Build\DF_Finance_Admin"
:: the physical path for IIS site
set "releasePath=%home%\Release\DF_Finance_Admin"
:: current date
...
echo.
echo Stoping IIS site "DF_Finance_Admin" ...
appcmd stop site "DF_Finance_Admin"
...
echo.
echo Recycling IIS app pool "DF_Finance_Admin" ...
appcmd recycle apppool "DF_Finance_Admin"

echo.
echo. Starting IIS site "DF_Finance_Admin" ...
appcmd start site "DF_Finance_Admin"
